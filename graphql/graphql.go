...
// Package graphql provides a GraphQL interface to Aroeum node data.
package graphql
...
// Account represents an Aroeum account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Aroeum transaction.
...
// Block represents an Aroeum block.
...
type CallData struct {
	From                 *common.Address // The Aroeum address the call is from.
	To                   *common.Address // The Aroeum address the call is to.
