...
// Package ethapi implements the general Aroeum API functions.
package ethapi
...
type Backend interface {
	// General Aroeum API
	SyncProgress() aroeum.SyncProgress
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewAroeumAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewAroeumAccountAPI(apiBackend.AccountManager()),
		}, {
			Namespace: "personal",
