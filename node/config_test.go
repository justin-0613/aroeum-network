...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "garo.ipc", false, filepath.Join(os.TempDir(), "garo.ipc")},
		{"data", "garo.ipc", false, "data/garo.ipc"},
		{"data", "./garo.ipc", false, "./garo.ipc"},
		{"data", "/garo.ipc", false, "/garo.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "garo.ipc", true, `\\.\pipe\garo.ipc`},
		{"data", "garo.ipc", true, `\\.\pipe\garo.ipc`},
		{"data", `\\.\pipe\garo.ipc`, true, `\\.\pipe\garo.ipc`},
	}
