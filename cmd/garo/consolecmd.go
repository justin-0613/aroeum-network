...
var (
	...
	consoleCommand = &cli.Command{
		...
		Description: `
The Garo console is an interactive shell for the JavaScript runtime environment
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://garo.ethereum.org/docs/interacting-with-garo/javascript-console.`,
	}
...
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://garo.ethereum.org/docs/interacting-with-garo/javascript-console.
This command allows to open a console on a running garo node.`,
	}
...
JavaScript API. See https://garo.ethereum.org/docs/interacting-with-garo/javascript-console`,
	}
)

// localConsole starts a new garo node, attaching a JavaScript console to it at the
// same time.
func localConsole(ctx *cli.Context) error {
	...
	if err != nil {
		return fmt.Errorf("failed to attach to the inproc garo: %v", err)
	}
...
// remoteConsole will connect to a remote garo instance, attaching a JavaScript
// console to it.
func remoteConsole(ctx *cli.Context) error {
	...
	if err != nil {
		utils.Fatalf("Unable to attach to remote garo: %v", err)
	}
	config := console.Config{
		DataDir: utils.MakeDataDir(ctx),
		DocRoot: ctx.String(utils.JSpathFlag.Name),
...
// ephemeralConsole starts a new garo node, attaches an ephemeral JavaScript
