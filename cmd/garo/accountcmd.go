...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Aroeum presale wallets",
		ArgsUsage: "",
		Description: `
    garo wallet import /path/to/my/presale.wallet

will prompt for your password and imports your aro presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Aroeum presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	garo wallet [options] /path/to/my/presale.wallet
...
between aroeum nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    garo account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    garo account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another aroeum instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := garoConfig{Node: defaultNodeConfig()}
	// Load config file.
