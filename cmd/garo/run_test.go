...
func init() {
	// Run the app if we've been exec'd as "garo-test" in runGaro.
	reexec.Register("garo-test", func() {
...
// spawns garo with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGaro(t *testing.T, args ...string) *testgaro {
	tt := &testgaro{}
	...
	// Boot "garo". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("garo-test", args...)
