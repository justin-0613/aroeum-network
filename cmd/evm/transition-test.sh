...
state generators can swap between a \`garo\`-based implementation and a \`parityvm\`-based
implementation.
...
doubt, the [`execution-apis`](https://github.com/aroeum-network/execution-apis) way
