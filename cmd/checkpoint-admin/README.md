...
*For a more detailed introduction to checkpoint, please see the LES [spec](https://github.com/justin-0613/devp2p/blob/master/caps/les.md).*
...
There are several hardcoded checkpoints in the [source code](https://github.com/justin-0613/go-aroeum/blob/master/params/config.go#L38) of the go-aroeum project. These checkpoints are updated by go-aroeum developers when new versions of software are released. Because light client users trust Garo developers to some extent, hardcoded checkpoints in the code can also be considered correct.
...
```shell
go get github.com/justin-0613/go-aroeum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/justin-0613/go-aroeum/blob/master/params/config.go#L251).*
