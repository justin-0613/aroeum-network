...
import (
	...
	ethdownloader "github.com/aroeum-network/go-aroeum/eth/downloader"
	...
	"github.com/aroeum-network/go-aroeum/p2p/simulations"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	aroeum, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, aroeum, &config)
	if err != nil {
		return nil, err
	}
	return aroeum, nil
