...
import (
	...
	"github.com/aroeum-network/go-aroeum/les/checkpointoracle"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some aro to user1
		...
		case 1:
			...
			// bankUser transfers more aro to user1
		...
		case 2:
			...
			// bankUser transfer some aro to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
