Name "garo ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/aroeum-network/go-aroeum/issues"
!define UPDATEURL "https://github.com/aroeum-network/go-aroeum/releases"
!define ABOUTURL "https://github.com/aroeum-network/go-aroeum#aroeum-go"
...
# Install garo binary
Section "Garo" GARO_IDX
  SetOutPath $INSTDIR
  file {{.Garo}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\garo.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\garo.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Garo incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Garo outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Garo UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Garo incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\garo.exe" "" "" "Aroeum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Garo outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\garo.exe" "" "" "Aroeum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Garo UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\garo.exe" "" "" "Aroeum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "AROEUM_SOCKET" "R" "HKLM" "\\.\pipe\garo.ipc"
  ${EnvVarUpdate} $0 "AROEUM_SOCKET" "A" "HKLM" "\\.\pipe\garo.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GARO_IDX}
    SectionGetSize ${GARO_IDX} $0
