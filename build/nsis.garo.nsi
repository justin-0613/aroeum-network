...
# 1. install garo for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for garo
# 5. create garo, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable AROEUM_SOCKET
...
!define GROUPNAME "Aroeum"
!define APPNAME "Garo"
!define DESCRIPTION "Official Go implementation of the Aroeum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since garo is installed global
