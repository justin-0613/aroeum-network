...
// mapped from textual names used in the tests below to actual Aroeum private
...
// address retrieves the Aroeum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Aroeum address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/aroeum-network/go-aroeum/issues/17593). Whilst this
