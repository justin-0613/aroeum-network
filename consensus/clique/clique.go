...
import (
	...
	lru "github.com/aroeum-network/go-aroeum/common/lru"
...
// ecrecover extracts the Aroeum account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the Aroeum address
...
// Aroeum testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Aroeum address of the signing key
...
// Author implements consensus.Engine, returning the Aroeum address recovered
