...
// Package types contains data types related to Aroeum consensus.
package types
...
// Header represents a block header in the Aroeum blockchain.
type Header struct {
...
// Block represents an entire block in the Aroeum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Aroeum RLP block format.
