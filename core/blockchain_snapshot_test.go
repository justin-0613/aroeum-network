...
// It can be used for testing that restart Garo normally.
...
// It can be used for testing that restart Garo after the crash.
...
// Tests a Garo restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Garo was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Garo was crashed and restarts with a broken snapshot. In this case
...
// Tests a Garo was running with snapshot enabled. Then restarts without
...
// Tests the Garo was running with snapshot enabled and resetHead is applied.
...
// Tests the Garo was running with a complete snapshot and then imports a few
