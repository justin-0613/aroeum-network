...
// timestampThreshold is the Aroeum mainnet genesis timestamp. It is used to
...
// NewID calculates the Aroeum fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Aroeum fork ID from an existing chain instance.
