...
pruning. Remember don't start the Garo without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "garo snapshot prune-state --help" for more details.
`
