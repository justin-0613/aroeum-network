...
// Package state provides a caching layer atop the Aroeum state trie.
package state
...
// StateDB structs within the aroeum protocol are used to store anything
...
//
// Carrying over the balance ensures that Aro doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/aroeum-network/go-aroeum/pull/16485#issuecomment-380438527),
