...
// Package ethclient provides a client for the Aroeum RPC API.
package ethclient
...
// Client defines typed wrappers for the Aroeum RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, aroeum.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*aroeum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (aroeum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q aroeum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q aroeum.FilterQuery, ch chan<- types.Log) (aroeum.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q aroeum.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg aroeum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg aroeum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg aroeum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*aroeum.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg aroeum.CallMsg) (uint64, error) {
...
func toCallArg(msg aroeum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *aroeum.SyncProgress {
	if p == nil {
		return nil
	}
	return &aroeum.SyncProgress{
