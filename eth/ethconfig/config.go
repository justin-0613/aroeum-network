...
// Defaults contains default settings for use on the Aroeum main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Aroeum main net block is used.
	...
	// canonical chain of all remote peers. Setting the option makes garo verify the
	...
	// send-transaction variants. The unit is aro.
	RPCTxFeeCap float64
