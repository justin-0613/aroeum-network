...
// testBackend is a mock implementation of the live Aroeum message handler. Its
...
func testGetNodeData(t *testing.T, protocol uint, drop bool) {
	...
	generator := func(i int, block *core.BlockGen) {
		switch i {
		case 0:
			// In block 1, the test bank sends account #1 some aro.
			...
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more aro to account #1.
