...
import (
	...
	"github.com/aroeum-network/go-aroeum/p2p/msgrate"
...
// Syncer is an Aroeum account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Aroeum state over the
// snap protocol.
