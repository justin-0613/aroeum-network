...
// AroeumAPI provides an API to access Aroeum full node-related information.
type AroeumAPI struct {
	e *Aroeum
}

// NewAroeumAPI creates a new Aroeum protocol API for full nodes.
func NewAroeumAPI(e *Aroeum) *AroeumAPI {
	return &AroeumAPI{e}
}

// Etherbase is the address that mining rewards will be send to.
func (api *AroeumAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase).
func (api *AroeumAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate.
func (api *AroeumAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *AroeumAPI) Mining() bool {
...
func NewMinerAPI(e *Aroeum) *MinerAPI {
	return &MinerAPI{e}
}
...
// AdminAPI is the collection of Aroeum full node related APIs for node
// administration.
...
func NewAdminAPI(eth *Aroeum) *AdminAPI {
...
// DebugAPI is the collection of Aroeum full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *Aroeum) *DebugAPI {
