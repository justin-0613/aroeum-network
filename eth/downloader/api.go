...
// Syncing provides information when this nodes starts synchronising with the Aroeum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  aroeum.SyncProgress `json:"status"`
}
