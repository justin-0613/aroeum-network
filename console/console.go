...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Aroeum requests through
...
// Welcome show summary of current Garo instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Garo JavaScript console!\n\n"

	// Print some generic Garo metadata
