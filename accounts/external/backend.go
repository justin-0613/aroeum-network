...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain aroeum.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to aroeum-type signature.
		signature[64] -= 27 // Transform V from Aroeum-legacy to 0/1
	}
