...
// the main Aroeum network.
var MainnetBootnodes = []string{
	// Aroeum Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/aroeum-network/discv4-dns-lists for more
// information.
